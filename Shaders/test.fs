...
db = sdSphere(p -vec3(-6.000000, 2.000000, -6.000000), 3.8);
sdf_ = sdf;
if (db < 0.001) {
...
db = sdSphere(p -vec3(-2.500000, 2.000000, -6.000000), 3.8);
sdf_ = sdf;
if (db < 0.001) {
   ...
   sdf = opUnion(sdf, sdf_);
db = sdSphere(p -vec3(1.000000, 2.000000, -6.000000), 3.8);
sdf_ = sdf;
if (db < 0.001) {
   ...
   sdf = opUnion(sdf, sdf_);
db = sdSphere(p -vec3(4.500000, 2.000000, -6.000000), 3.8);
sdf_ = sdf;
if (db < 0.001) {
   ...
   sdf = opUnion(sdf, sdf_);
db = sdSphere(p -vec3(8.000000, 2.000000, -6.000000), 3.8);
sdf_ = sdf;
if (db < 0.001) {
